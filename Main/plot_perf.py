...
def plot_graph(result_1, result_2, result_3,result_4,x_lab,y_lab,tick_labels1,filename):
    colorr = ['#EEBBF4','#AD6CC1','#632E82','#351458']
    ...
    # labels for bars
    labels = ['LHFGSO-DMN with iteration 5', 'LHFGSO-DMN with iteration 10 ', 'LHFGSO-DMN with iteration 15','LHFGSO-DMN with iteration 20']  # x-axis labels
    ...
    plt.legend(loc='lower center', bbox_to_anchor=(0.5, -0.5), ncol=2,fontsize=10)
...
# data = pd.read_excel('Acc_CA.xlsx',header=None)
data = np.load('ACC_tr_pa.npy')
